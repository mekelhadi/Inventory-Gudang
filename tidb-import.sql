...
ALTER TABLE `activity_log` ADD PRIMARY KEY (`id`), ADD KEY `subject` (`subject_type`,`subject_id`), ADD KEY `causer` (`causer_type`,`causer_id`), ADD KEY `activity_log_log_name_index` (`log_name`);
ALTER TABLE `barangs` ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `barangs_kode_barang_unique` (`kode_barang`);
ALTER TABLE `barang_keluars` ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `barang_keluars_kode_transaksi_unique` (`kode_transaksi`);
ALTER TABLE `barang_masuks` ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `barang_masuks_kode_transaksi_unique` (`kode_transaksi`);
...
ALTER TABLE `satuans` ADD PRIMARY KEY (`id`);
ALTER TABLE `suppliers` ADD PRIMARY KEY (`id`);
ALTER TABLE `users` ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `users_email_unique` (`email`);

ALTER TABLE `activity_log` AUTO_INCREMENT = 56;
ALTER TABLE `barangs` AUTO_INCREMENT = 11;
ALTER TABLE `barang_keluars` AUTO_INCREMENT = 2;
ALTER TABLE `barang_masuks` AUTO_INCREMENT = 11;
ALTER TABLE `customers` AUTO_INCREMENT = 4;
ALTER TABLE `failed_jobs` AUTO_INCREMENT = 1;
ALTER TABLE `jenis` AUTO_INCREMENT = 6;
ALTER TABLE `migrations` AUTO_INCREMENT = 16;
ALTER TABLE `personal_access_tokens` AUTO_INCREMENT = 1;
ALTER TABLE `roles` AUTO_INCREMENT = 4;
ALTER TABLE `satuans` AUTO_INCREMENT = 4;
